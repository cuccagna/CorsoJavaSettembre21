...
public class ImpiegatoSuCommissionePiuBase  {
    ...
    public ImpiegatoSuCommissionePiuBase( String n, String c, String nps, 
       double vend, double tasso ,double salario)
    {
    ...
    public double paga()
    {
        //oppure return salarioBase + tassoCommissione * vendite;
       return getSalarioBase() + (getTassoCommissione() * getVendite());
    } 
