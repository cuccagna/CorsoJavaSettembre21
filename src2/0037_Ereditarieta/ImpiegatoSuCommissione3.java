public class ImpiegatoSuCommissione3 implements Pagamento{
    ...
    public ImpiegatoSuCommissione3( String n, String c, String nps, 
    ...
    public double getPagamento()
    {
        ...
        double paga = getTassoCommissione() * getVendite();
        return (paga<MAX) ? paga : MAX;
    } 
